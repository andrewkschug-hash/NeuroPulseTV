...
import com.grid.tv.ui.platform.rememberDeviceFormFactor
...
fun GridTheme(
    ...
    androidx.compose.runtime.CompositionLocalProvider(LocalDeviceFormFactor provides deviceFormFactor) {
        MaterialTheme(
