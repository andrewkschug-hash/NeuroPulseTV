...
class EpgScheduler @Inject constructor(
    ...
    fun scheduleAtLaunch() {
        Log.i(TAG, "scheduleAtLaunch: periodic EPG refresh (6h) + resolver (7d)")
    ...
    fun runEpgRefreshNow() {
        Log.i(TAG, "runEpgRefreshNow: enqueueing one-shot EpgRefreshWorker (xmltv.php / playlist EPG URLs)")
